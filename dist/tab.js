...
exports.getBlitzkriegTabIndex = exports.setBlitzkriegEnabled = exports.isBlitzkriegEnabled = exports.prepareTabFonts = exports.setupTabs = void 0;
...
exports.prepareTabFonts = prepareTabFonts;
...
function isBlitzkriegEnabled() {
    return sc.options.get(enableId);
}
exports.isBlitzkriegEnabled = isBlitzkriegEnabled;
function setBlitzkriegEnabled(bool) {
    sc.options.set(enableId, bool);
}
exports.setBlitzkriegEnabled = setBlitzkriegEnabled;
function getBlitzkriegTabIndex() {
    return sc.OPTION_CATEGORY[name];
}
exports.getBlitzkriegTabIndex = getBlitzkriegTabIndex;
